...
import com.grizzly.application.models.Customer;
...
public class RequestDialog extends JDialog implements IView {
    ...
    public void initializeComponents() {
        ...
        cancel = new com.grizzly.application.views.components.fields.Button("Cancel", ButtonSize.SMALL);
        approve = new com.grizzly.application.views.components.fields.Button(isApproved ? "Reject" : "Approve", ButtonSize.SMALL);
