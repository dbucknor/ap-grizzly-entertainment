...
public class CheckoutPanel extends JPanel {
    ...
    private JPanel createContainerPanel() {
        ...
        gbc.gridy++;
        add(createMainPanel("Totals:"), containerPanel, gbc);

        return containerPanel;
    }

    private void add(Component component, JPanel containerPanel, GridBagConstraints gbc) {
        containerPanel.add(component, gbc);
    }
